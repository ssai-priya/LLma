java_prompt_new='''I want to generate java code which follow object oriented programming rules of java using logic of rpg code which is given in plain text format.
...
Now the User will come and will provide business logic, please generate correct and running Java code based on the business logic provided by the user as shown in above example. Also include proper comments in the code. 
'''
