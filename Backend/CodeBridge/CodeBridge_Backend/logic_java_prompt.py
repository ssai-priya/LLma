java_prompt='''I want to generate python code which follow object oriented programming rules of python using logic of Assembly Language code which is given in plain text format.
...
Now the User will come and will provide business logic, please generate correct and running Python code as shown in above example without any initial text in a JSON format with "javaCode" as the key. Also include proper comments in the code. 
'''
