...
urlpatterns = [
    ...
    path('api/mermaid-diagram/', views.HigherLevelMermaidDiagram.as_view(), name='mermaid_diagram'),
    path('api/mermaid-flowchart/', views.HigherLevelMermaidFlowchart.as_view(), name='mermaid_flowchart'),
]
